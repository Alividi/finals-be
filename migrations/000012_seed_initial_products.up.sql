...
(1, 1, 1, 'Customer Terminal Enhanched', 'Data Standar Tanpa Batas, Prioritas Jaringan, Dukungan Prioritas', 1000000, '-'),
(2, 1, 1, 'Customer Terminal Adaptive', 'Data Standar Tanpa Batas, Prioritas Jaringan, Dukungan Prioritas', 3000000, '-'),
(3, 2, 2, 'Customer Terminal Adaptive', 'Data Daratan Tanpa Batas, Dalam Perjalanan + Penggunaan Laut, Prioritas Jaringan, Dukungan Prioritas', 3000000, '-');
...
(2 ,1, 'Apa yang terjadi jika saya melebihi batas data?',
'Paket Fixed Site akan dikembalikan ke laju data standar tanpa batas.'),

(3, 1, 'Adakah solusi bila kuota data prioritas habis?',
...
(4, 1, 'Apakah saya bisa mengubah paket layanan saya?',
'Ya, paket layanan dapat diubah di dalam akun satmobile Anda. Informasi lebih lanjut tersedia hubungi kami.'),

(5, 1, 'Dapatkah saya menjeda paket layanan saya? Bagaimana cara menjeda/membatalkan layanan?',
...
(6, 1, 'Dapatkah saya berbagi paket layanan di antara beberapa satmobile Kit?',
'Tidak, setiap satmobile Kit membutuhkan paket layanannya sendiri.'),

(7, 1, 'Apa yang terjadi jika saya perlu memindahkan satmobile saya ke lokasi yang berbeda, tetapi tidak memerlukannya untuk berpindah tempat?',
...
(8, 1, 'Berapa banyak pengguna/perangkat yang dapat didukung oleh satu satmobile Kit ?',
...
(9, 1, 'Apakah satu satmobile kit dapat digunakan oleh beberapa gedung / lokasi?',
...
(10, 1, 'Seberapa handal koneksinya?',
...
(16, 2, 'Apa yang terjadi jika saya melebihi batas data?', 
...
(20, 2, 'Apakah saya bisa berbagi layanan antar kendaraan?', 
...
(21, 2, 'Bagaimana jika saya berpindah lokasi atau jalur laut?', 
...
(22, 2, 'Berapa banyak perangkat yang bisa terkoneksi dengan satu unit?', 
...
(23, 2, 'Bisakah digunakan di kapal atau kendaraan berat?', 
...
(24, 2, 'Apakah koneksi tetap stabil saat bergerak?', 
...
(25, 2, 'Dapatkah Land Satmobile menjadi koneksi cadangan?', 
'Banyak pengguna bisnis menggunakan layanan ini sebagai koneksi cadangan saat koneksi utama tidak tersedia.'),

(26, 2, 'Seberapa cepat layanan bisa digunakan setelah pembelian?', 
...
(27, 2, 'Bagaimana memesan dalam jumlah besar untuk armada?', 
...
(28, 2, 'Apa saja skema layanan yang tersedia?', 
